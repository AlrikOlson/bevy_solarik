...
renderer including the analytic-light-reflection change. The source is the
...
SCENE=bistro NR_RES=3840x2160 NR_START=100 NR_CAPTURE=1 NR_WARMUP=240 \
  NR_OUT=../artifacts/bevy-sponza/analytic-readme-street ./capture.sh off
SCENE=bistro NR_RES=3840x2160 NR_START=400 NR_CAPTURE=1 NR_WARMUP=240 \
  NR_OUT=../artifacts/bevy-sponza/analytic-readme-night ./capture.sh off
```
